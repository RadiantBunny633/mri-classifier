"""
RF Data Loader — MRI Alzheimer's Classifier
=================================================================
Reuses preprocessing.py. Loads and splits the dataset
identically to the CNN pipeline so comparisons are easy to compare.
"""
...
def load_dataset(data_dir, target_size=(128, 128)):
    """
    Load all images from data_dir organized by class subfolder.
    """
    images      = []
    labels      = []
    class_names = []
